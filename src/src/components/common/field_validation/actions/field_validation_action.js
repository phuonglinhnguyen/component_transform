...
import * as field_constants from '../../../project/components/field_value_definitions/constants/field_constants'
    ...
    record: Object) => (dispatch, getState) => {
        ...
        if (fieldDefine &&
            ...
            try {
                ...
                var fnc = Function(`${input}`, `${fieldDefine[field_constants.KEY_VALIDATION][validation_constants.KEY_VALIDATION_SCRIPT]}`);
