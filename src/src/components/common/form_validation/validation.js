...
import {
    KEY_PATTERN,
    KEY_VALIDATION,
} from '../../project/components/field_value_definitions/constants/field_constants';
import {
    KEY_PATTERN_CONTENT,
    KEY_PATTERN_DESCRIPTION
} from '../../configuration/components/pattern_definitions/constants/pattern_constants';

import {
    KEY_VALIDATION_SCRIPT,
    KEY_VALIDATION_ARGUMENTS,
} from '../../configuration/components/validation_definitions/constants/validation_constants';
...
export const getValidationSection = (sections: Array<Object>) => {
    ...
    sections.forEach(section => {
        rs[section.name] = {
            checkValidate: getValitionFuncSection(section),
        }
    })
    return rs;
}
