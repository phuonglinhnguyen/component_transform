...
const ProjectResponseEvaluationDialog = ({ response_evaluation_dialog, actions, Translate }) => {
  let {
    open_dialog,
    title_dialog,
    handleClickSubmit,
...
ProjectResponseEvaluationDialog.propTypes = {
...
export default ProjectResponseEvaluationDialog;
