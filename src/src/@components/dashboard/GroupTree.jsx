                ...
                <React.Fragment>
                    ...
                    <Collapse in={this.state.open} timeout="auto" className={classes.nested} unmountOnExit >
                        <List component="div" disablePadding>
                            {
                                item.childs && item.childs.map(item => <GroupItem item={item} itemId={itemId}  redirectGroup={redirectGroup}/>)
                            }
                        </List>
                    </Collapse >
                </React.Fragment>
            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            {
                                datas.map(item => <GroupItem item={item} itemId={itemId} redirectGroup={redirectGroup} />)
                            }
                        </List >
                    </Collapse>
                </List>
