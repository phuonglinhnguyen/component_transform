    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement("div", { className: classes.container },
            ...
            React.createElement("div", { className: classes.item },
                React.createElement(TextField_1.default, { id: "Seconds", placeholder: react_redux_i18n_1.I18n.t('cron_trigger.second'), value: data.second, onChange: handleChange("seconds"), type: "number", helperText: data.errorText, error: data.errorText.length > 0, fullWidth: true })),
            React.createElement("div", null, React.createElement(react_redux_i18n_1.Translate, { value: 'cron_trigger.second' }))),
        React.createElement("div", { className: classes.cronTime },
            React.createElement("div", null, cronTime.length > 0 && "(" + cronTime + ")"))));
}
exports.default = styles_1.withStyles(styles, { withTheme: true })(SecondsTab);
